...
public class SampleHelperClass {
	
	static Logger logger = LoggerFactory.getLogger(SampleHelperClass.class);
	...
	public SampleHelperClass() {
		...
		logger.info("***** UITestHAndler: APP_BASE_URL " + SampleHelperClass.APP_BASE_URL);
	}
